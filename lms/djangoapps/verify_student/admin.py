...
from lms.djangoapps.verify_student.models import ManualVerification, SoftwareSecurePhotoVerification, SSOVerification, SSOReverificationConfig
...
@admin.register(SSOReverificationConfig)
class SSOReverificationAdmin(admin.ModelAdmin):
    """
    Admin for the Reverification table.
    """
    pass
